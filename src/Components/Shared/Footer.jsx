...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#ECF5FF] text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Heritage Nest</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-5">
                    <div className="space-y-3">
                        <h3 className="uppercase text-[#667085]">Product</h3>
                        <ul className="space-y-1 text-[#475467] text-md font-semibold">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-[#667085]">Company</h3>
                        <ul className="space-y-1 text-[#475467] text-md font-semibold">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-[#667085]">Resources</h3>
                        <ul className="space-y-1 text-[#475467] text-md font-semibold">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-[#667085]">Social</h3>
                        <ul className="space-y-1 text-[#475467] text-md font-semibold">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-[#667085]">Legal</h3>
                        <ul className="space-y-1 text-[#475467] text-md font-semibold">
                            <li>
            ...
            <div className="container mx-auto flex justify-between">
                <div className="py-6 text-sm text-gray-600">© 2024 Heritage - Nest. All rights reserved.</div>
                <div className="flex justify-start text-[#0059B1] space-x-3">
